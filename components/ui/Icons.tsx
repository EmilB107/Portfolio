...
export const ExternalLinkIcon = ({ className = "w-4 h-4 transition-all duration-200 text-slate-400 translate-y-0.5 group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:text-teal-300" }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const ArrowLeftIcon = ({ className = "w-4 h-4 transition-all duration-200 text-slate-400 group-hover:-translate-x-1 group-hover:text-teal-300" }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
